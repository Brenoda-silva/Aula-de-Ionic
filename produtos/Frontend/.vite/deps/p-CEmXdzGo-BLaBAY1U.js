import { bn as f$1, xn as i, yn as c } from "./dist-FhAQQxNt.js";
import { n as o, t as d } from "./p-ZjP4CjeZ-D1RiXws9.js";
import { h as u$1, l as l$1, o as e } from "./p-DgbT0exM-BlR-mqzM.js";
import { n as t, t as i$1 } from "./p-D13Eaw-8-DtbfIbzt.js";
//#region node_modules/@ionic/core/components/p-CEmXdzGo.js
/*!
...
}, p = "input, textarea, [no-blur], [contenteditable]", m = "$ionPaddingTimer", b = (o, n, t) => {
	const i = o[m];
...
var S = 0;
var h = "data-ionic-skip-scroll-assist", D = (o) => {
	var n;
	...
	null !== i && i === r || (o.setAttribute(h, "true"), o.focus());
}, v = async (o, n, r, a, e, s, d = !1, c$1 = 0, l = !0) => {
	if (!r && !a) return;
	const f = ((o, n, t, i) => {
		var r;
		return ((o, n, t, i) => {
	...
	if (r && Math.abs(f.scrollAmount) < 4) return D(n), void (s && null !== r && (b(r, S), y(n, r, (() => S = 0))));
	if (u(o, n, !0, f.inputSafeY, d), D(n), s && r && (S = f.scrollPadding, b(r, S)), "undefined" != typeof window) {
		let a;
		const e = async () => {
			void 0 !== a && clearTimeout(a), window.removeEventListener("ionKeyboardDidShow", d), window.removeEventListener("ionKeyboardDidShow", e), r && await c(r, 0, f.scrollAmount, f.scrollDuration), u(o, n, !1, f.inputSafeY), document.activeElement === n && D(n), s && y(n, r, (() => S = 0));
		}, d = () => {
	...
	if (void 0 === o) return;
	const l = "ios" === i, f = "android" === i, w = t$1.getNumber("keyboardHeight", 290), m = t$1.getBoolean("scrollAssist", !0), b = t$1.getBoolean("hideCaretOnScroll", l), y = t$1.getBoolean("inputBlurring", !1), S = t$1.getBoolean("scrollPadding", !0), D = Array.from(o.querySelectorAll("ion-input, ion-textarea")), x = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), K = await t.getResizeMode(), g = async (n) => {
		await new Promise(((o) => e(n, o)));
		const t = n.shadowRoot || n, i = t.querySelector("input") || t.querySelector("textarea"), c = f$1(n), l = c ? null : n.closest("ion-footer");
		if (i) {
			if (c && b && !x.has(n)) {
				const o = ((o, n, t) => {
					if (!t || !n) return () => {};
			...
			if ("date" !== i.type && "datetime-local" !== i.type && (c || l) && m && !M.has(n)) {
				const t = ((n, t, i, r, a, e, s, c = !1) => {
					const l = e && (void 0 === s || s.mode === i$1.None);
					let u = !1;
					const f = void 0 !== d ? d.innerHeight : 0, w = (o) => {
						!1 !== u ? v(n, t, i, r, o.detail.keyboardHeight, l, c, f, !1) : u = !0;
					}, p = () => {
						u = !1, d?.removeEventListener("ionKeyboardDidShow", w), n.removeEventListener("focusout", p);
					}, m = async () => {
						t.hasAttribute(h) ? t.removeAttribute(h) : (v(n, t, i, r, a, l, c, f), d?.addEventListener("ionKeyboardDidShow", w), n.addEventListener("focusout", p));
					};
...
//# sourceMappingURL=p-CEmXdzGo-BLaBAY1U.js.map